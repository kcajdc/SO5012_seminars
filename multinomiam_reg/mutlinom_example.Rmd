...
```
The coefficients on Age are significant in the Conservative and Other equations, but not in the Liberal Democrat equation.  That is, there is strong evidence of a positive association between age and support for Conservative relative to Labour, and strong evidence of a positive association between age and support for Other relative to Labour, holding qualifications constant. However, there does not appear to be a change associated with aging for support of the Lib Dem over the Labour party.
